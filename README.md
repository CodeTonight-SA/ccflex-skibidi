...
|---|-------------|--------|----------------|------------------|-------|------|--------|------|
| 1 | [Lourens Cornelius Scheepers (V>>) — seeded 2026-05-19](https://codetonight-sa.github.io/ccflex-skibidi) | ~265.1m | 20 days | 8d 21h 8m | ≈2155× | 875 | ✓ verified | [card](https://ccflex-skibidi.pages.dev/cards/ccflex-seed) |
